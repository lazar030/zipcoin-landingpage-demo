! function t(e, n, i) {
      ...
      (function (t) {
          ! function (i) {
              ...
              if (w = {
                  ...
                  if (e.exports == g) y.exports = w;
                  else
                      for (b in w) w.hasOwnProperty(b) && (g[b] = w[b]);
              else i.punycode = w
          }(this)
  ...
  3: [function (t, e, n) {
      ...
      e.exports = function (t, e, n, o) {
          ...
          l > 0 && u > l && (u = l);
          for (var c = 0; c < u; ++c) {
              var h, d, f, p, m = t[c].replace(a, "%20"),
                  g = m.indexOf(n);
  ...
  6: [function (t, e, n) {
      ...
      i.prototype.parse = function (t, e, n) {
          ...
          if (m && (n.hostname = "", n.port = null, n.host && ("" === p[0] ? p[0] = n.host : p.unshift(n.host)), n.host = "", t.protocol && (t.hostname = null, t.port = null, t.host && ("" === r[0] ? r[0] = t.host : r.unshift(t.host)), t.host = null), d = d && ("" === r[0] || "" === p[0])), u) n.host = t.host || "" === t.host ? t.host : n.host, n.hostname = t.hostname || "" === t.hostname ? t.hostname : n.hostname, n.search = t.search, n.query = t.query, p = r;
          else if (r.length) p || (p = []), p.pop(), p = p.concat(r), n.search = t.search, n.query = t.query;
          else if (!h(t.search)) {
              if (m) {
      ...
      ! function (t, n) {
          ...
          function y(t, e, n, i, r) {
              for (var o, s, a, l, u, c, h, d = t.length, y = f(e), v = [], w = 0; w < d; w++)
                  ...
                  if (!ht.leadingWhitespace && Bt.test(s) && v.push(e.createTextNode(Bt.exec(s)[0])), !ht.tbody)
                      for (s = "table" !== u || Gt.test(s) ? "<table>" !== h[1] || Gt.test(s) ? 0 : l : l.firstChild, o = s && s.childNodes.length; o--;) ft.nodeName(c = s.childNodes[o], "tbody") && !c.childNodes.length && s.removeChild(c);
          ...
          function D(t, e, n, i) {
              ...
              if (h && (u = y(e, t[0].ownerDocument, !1, t, i), r = u.firstChild, 1 === u.childNodes.length && (u = r), r || i)) {
                  ...
                  if (s)
                      for (l = a[a.length - 1].ownerDocument, ft.map(a, S), c = 0; c < s; c++) o = a[c], It.test(o.type || "") && !ft._data(o, "globalEval") && ft.contains(l, o) && (o.src ? ft._evalUrl && ft._evalUrl(o.src) : ft.globalEval((o.text || o.textContent || o.innerHTML || "").replace(oe, "")));
                  u = r = null
              }
              return t
          }
          ...
          function q(t, e, n) {
              ...
              if (ft.isEmptyObject(d)) "inline" === ("none" === u ? j(t.nodeName) : u) && (f.display = u);
              else {
          ...
          function B(t, e, n) {
              ...
              for (I(c, u.opts.specialEasing); o < s; o++)
                  if (i = B.prefilters[o].call(u, t, c, u.opts)) return ft.isFunction(i.stop) && (ft._queueHooks(u.elem, u.opts.queue).stop = ft.proxy(i.stop, i)), i;
          ...
          ft.fn = ft.prototype = {
              ...
              for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || ft.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
                  if (null != (r = arguments[a]))
                      for (i in r) t = s[i], n = r[i], s !== n && (u && n && (ft.isPlainObject(n) || (e = ft.isArray(n))) ? (e ? (e = !1, o = t && ft.isArray(t) ? t : []) : o = t && ft.isPlainObject(t) ? t : {}, s[i] = ft.extend(u, o, n)) : void 0 !== n && (s[i] = n));
              return s
          }, ft.extend({
          ...
          var vt = function (t) {
              ...
              function y(t, e, n, r, o, s) {
                  return r && !r[H] && (r = y(r)), o && !o[H] && (o = y(o, s)), i(function (i, s, a, l) {
                      var u, c, h, d = [],
                          ...
                          w = n ? o || (i ? t : p || r) ? [] : s : v;
                      if (n && n(v, w, a, l), r)
                          for (u = g(w, f), r(u, [], a, l), c = u.length; c--;)(h = u[c]) && (w[f[c]] = !(v[f[c]] = h));
                      if (i) {
                          if (o || t) {
                              if (o) {
              ...
              var b, x, _, k, S, T, C, D, M, N, j, E, O, A, P, L, Y, F, R, H = "sizzle" + 1 * new Date,
                  W = t.document,
                  q = 0,
                  I = 0,
                  B = n(),
                          ...
                          return 1 === i && 0 === r ? function (t) {
                              ...
                              if (g) {
                                  ...
                                  if (p = [s ? g.firstChild : g.lastChild], s && v) {
                                      ...
                                      for (;
                                          (d = ++f && d && d[m] || (w = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++w || (v && (h = d[H] || (d[H] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[t] = [q, w]), d !== e)););
          ...
          ft.Callbacks = function (t) {
              ...
              when: function (t) {
                  ...
                  if (s > 1)
                      for (e = new Array(s), n = new Array(s), i = new Array(s); r < s; r++) o[r] && ft.isFunction(o[r].promise) ? o[r].promise().progress(u(r, n, e)).done(u(r, i, o)).fail(l.reject) : --a;
          ...
          ft.fn.ready = function (t) {
              ...
              if (!jt)
                  if (jt = ft.Deferred(), "complete" === it.readyState || "loading" !== it.readyState && !it.documentElement.doScroll) t.setTimeout(ft.ready);
          ...
          ft.event = {
              ...
              trigger: function (e, n, i, r) {
                  ...
                  if (a = c = i = i || it, 3 !== i.nodeType && 8 !== i.nodeType && !Zt.test(f + ft.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), s = f.indexOf(":") < 0 && "on" + f, e = e[ft.expando] ? e : new ft.Event(f, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ft.makeArray(n, [e]), u = ft.event.special[f] || {}, r || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                      ...
                      for (h = 0;
                          (a = d[h++]) && !e.isPropagationStopped();) e.type = h > 1 ? l : u.bindType || f, o = (ft._data(a, "events") || {})[e.type] && ft._data(a, "handle"), o && o.apply(a, n), o = s && a[s], o && o.apply && Ot(a) && (e.result = o.apply(a, n), e.result === !1 && e.preventDefault());
                  ...
                  if (a[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                      for (s = ft.event.handlers.call(this, t, l), e = 0;
                          ...
                          for (t.currentTarget = r.elem, n = 0;
                              (o = r.handlers[n++]) && !t.isImmediatePropagationStopped();) t.rnamespace && !t.rnamespace.test(o.namespace) || (t.handleObj = o, t.data = o.data, i = ((ft.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
          ...
          ft.extend({
              ...
              clone: function (t, e, n) {
                  ...
                  if (ht.html5Clone || ft.isXMLDoc(t) || !te.test("<" + t.nodeName + ">") ? o = t.cloneNode(!0) : (ae.innerHTML = t.outerHTML, ae.removeChild(o = ae.firstChild)), !(ht.noCloneEvent && ht.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ft.isXMLDoc(t)))
                      for (i = p(o), a = p(t), s = 0; null != (r = a[s]); ++s) i[s] && C(r, i[s]);
                  if (e)
                      if (n)
                  ...
                  select: {
                      ...
                      set: function (t, e) {
                          for (var n, i, r = t.options, o = ft.makeArray(e), s = r.length; s--;)
                              if (i = r[s], ft.inArray(ft.valHooks.option.get(i), o) > -1) try {
                                  i.selected = n = !0
                              } catch (t) {
                                  i.scrollHeight
                              } else i.selected = !1;
          ...
          var Ee, Oe, Ae = ft.expr.attrHandle,
          ...
          ft.fn.extend({
              ...
              removeAttr: function (t, e) {
                  var n, i, r = 0,
                      o = e && e.match(Nt);
                  if (o && 1 === t.nodeType)
                      for (; n = o[r++];) i = ft.propFix[n] || n, ft.expr.match.bool.test(n) ? Ye && Le || !Pe.test(n) ? t[i] = !1 : t[ft.camelCase("default-" + n)] = t[i] = !1 : ft.attr(t, n, ""), t.removeAttribute(Le ? n : i)
              }
          }), Oe = {
              set: function (t, e, n) {
          ...
          ft.fn.extend({
              ...
              toggleClass: function (t, e) {
                  ...
                  return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function (n) {
                      ...
                      var e, i, r, o;
                      if ("string" === n)
                          for (i = 0, r = ft(this), o = t.match(Nt) || []; e = o[i++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
              ...
              hasClass: function (t) {
                  var e, n, i = 0;
                  for (e = " " + t + " "; n = this[i++];)
                      if (1 === n.nodeType && (" " + U(n) + " ").replace(He, " ").indexOf(e) > -1) return !0;
                  return !1
              }
          ...
          ft.extend({
              ...
              ajax: function (e, n) {
                  ...
                  var r, o, s, a, l, u, c, h, d = ft.ajaxSetup({}, n),
                      f = d.context || d,
          ...
          ft.fn.load = function (t, e, n) {
              ...
              setOffset: function (t, e, n) {
                  var i, r, o, s, a, l, u, c = ft.css(t, "position"),
                      h = ft(t),
                      d = {};
      ...
      ! function (t, i) {
          ...
          function y(t, e) {
              ...
              if (g(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), g(e._i) || (t._i = e._i), g(e._f) || (t._f = e._f), g(e._l) || (t._l = e._l), g(e._strict) || (t._strict = e._strict), g(e._tzm) || (t._tzm = e._tzm), g(e._isUTC) || (t._isUTC = e._isUTC), g(e._offset) || (t._offset = e._offset), g(e._pf) || (t._pf = f(e)), g(e._locale) || (t._locale = e._locale), yi.length > 0)
                  for (n in yi) i = yi[n], r = e[i], g(r) || (t[i] = r);
              return t
          }
          ...
          function pi() {
              var t, e, n, i = po(this._milliseconds) / 1e3,
                  r = po(this._days),
                  o = po(this._months);
      ...
      (function () {
          ...
          function o(t, e) {
              var n = A.length,
                  ...
                  o = "constructor";
              for (b.has(t, o) && !b.contains(e, o) && e.push(o); n--;) o = A[n],
          ...
          var P = function (t, e, n, i) {
              ...
              if (n.push(t), i.push(e), o) {
                  ...
                  for (; l--;)
                      if (!P(t[l], e[l], n, i)) return !1
              } else {
                  var u, c = b.keys(t);
                  if (l = c.length, b.keys(e).length !== l) return !1;
                  for (; l--;)
                      if (u = c[l], !b.has(e, u) || !P(t[u], e[u], n, i)) return !1
              }
  ...
  12: [function (t, e, n) {
      (function (n) {
          ...
          function a(t) {
              ...
              if (t.offsetX) e.x = t.offsetX, e.y = t.offsetY;
      ...
      (function (n) {
          ...
          i.prototype = Object.create(s.prototype), i.prototype.constructor = i, i.prototype.build = function () {
              ...
              if (this.stories = t, this.campaign)
                  for (var e = 0; e < this.stories.length; e++) this.stories[e].url = c.setMediumCampaign(this.stories[e].url, "widget", "News Ticker Widget");
      ...
      (function (t) {
          ...
          n.prototype.register = function (t, e) {
              ...
              if (this.last[t] = e, this.callbacks.hasOwnProperty(t))
                  for (var n = 0; n < this.callbacks[t].length; n++) try {
  ...
  27: [function (t, e, n) {
      function i(t) {
          ...
          switch (isNaN(n) || (this.rows = Math.max(1, Math.min(10, n))), this.postBuildClasses = [], "true" == this.el.attr("bw-noshadow") && this.postBuildClasses.push("btcwdgt-noshadow"), this.colors = s.default, this.el.attr("data-bw-theme")) {
              case "light":
                  // this.postBuildClasses.push("btcwdgt-light"), this.colors = s.light
                  console.log(this.el.attr("data-bw-theme"));
                  var optionString = this.el.attr("data-options");
                  Option = s.light;
                  if (optionString != undefined) {
                      var customOption = JSON.parse(optionString);
                      Option = $.extend({}, s.light, customOption);
                  }
                  this.postBuildClasses.push("btcwdgt-light"), this.colors = Option;
          }
