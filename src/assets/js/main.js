...
$(function () {
    ...
    AmCharts.makeChart("chartdiv", {
        ...
        "dataProvider": [{
            ...
            {
                "category": "Incentives & Promotions",
                "column-1": "2"
            },
            {
                "category": "Bounties",
    ...
    //flip map
    var _txt = '<i class="fa fa-map-marker-alt"></i>VIEW MAP',
        _alterTxt = '<i class="fa fa-envelope" style="margin-top:15px; margin-right:15px;"></i>CONTACT US';
    $.fn.extend({
